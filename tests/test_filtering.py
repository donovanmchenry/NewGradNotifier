...
def test_filtering_rejects_internships_and_non_us_roles():
    ...
    assert is_relevant_role("Software Engineer, Mid", "Backend platform role", settings, "new_grad_jobs_repo") is False
    assert is_relevant_role("Experienced Software Engineer", "Backend platform role", settings, "new_grad_jobs_repo") is False
